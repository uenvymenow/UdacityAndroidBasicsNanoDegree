...
public class LedZeppelin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","Good Times Bad Times"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","Babe I'm Gonna Leave You"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","You Shook Me"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","Dazed and Confused"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","Your Time Is Gonna Come"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","Black Mountain Side (instrumental)"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","Communication Breakdown"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","I Can't Quit You Baby"));
        songList.add(new Songs(R.drawable.led_zeppelin_album_led_zeppelin, "Led Zeppelin","How Many More Times"));
