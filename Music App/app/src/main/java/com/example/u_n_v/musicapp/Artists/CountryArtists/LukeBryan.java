...
public class LukeBryan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        albumList.add(new Albums(R.drawable.tailgates_and_tanlines_album_luke_bryan,"Tailgates & Tanlines")); // Image retrieved from https://en.wikipedia.org/wiki/Tailgates_%26_Tanlines
        albumList.add(new Albums(R.drawable.what_makes_you_country_album_luke_bryan,"What Makes You Country")); // Image retrieved from https://en.wikipedia.org/wiki/What_Makes_You_Country
