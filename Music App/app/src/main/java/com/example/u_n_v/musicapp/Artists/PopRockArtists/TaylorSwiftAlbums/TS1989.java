...
public class TS1989 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Welcome to New York"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Blank Space"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Style"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Out of the Woods"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "All You Had to Do Was Stay"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Shake It Off"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "I Wish You Would"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Bad Blood"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Wildest Dreams"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "How You Get the Girl"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "This Love"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "I Know Places"));
        songList.add(new Songs(R.drawable.ts_1989_album_taylor_swift, "Clean"));
