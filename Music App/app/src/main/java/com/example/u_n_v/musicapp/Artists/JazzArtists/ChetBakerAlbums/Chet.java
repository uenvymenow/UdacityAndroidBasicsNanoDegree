...
public class Chet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","Alone Together"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","How High the Moon"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","It Never Entered My Mind"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","'Tis Autumn"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","If You Could See Me Now"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","September Song"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","You'd Be So Nice to Come Home To"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","Time on My Hands (You in My Arms)"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","You and the Night and the Music"));
        songList.add(new Songs(R.drawable.chet_album_chet_baker, "Chet","Early Morning Mood"));
