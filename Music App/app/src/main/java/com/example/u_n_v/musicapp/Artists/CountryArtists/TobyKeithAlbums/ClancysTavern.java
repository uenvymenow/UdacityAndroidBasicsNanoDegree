...
public class ClancysTavern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Made in America"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "I Need to Hear a Country Song"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Clancy's Tavern"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Tryin' to Fall in Love"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Just Another Sundown"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Beers Ago"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "South of You"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Club Zydeco Moon"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "I Won't Let You Down"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Red Solo Cup"));
        songList.add(new Songs(R.drawable.clancys_tavern_album_toby_keith, "Chill-Axin'"));
