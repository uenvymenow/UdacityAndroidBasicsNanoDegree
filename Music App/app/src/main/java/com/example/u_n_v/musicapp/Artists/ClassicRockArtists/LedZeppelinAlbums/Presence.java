...
public class Presence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "Achilles Last Stand"));
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "For Your Life"));
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "Royal Orleans"));
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "Nobody's Fault but Mine"));
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "Candy Store Rock"));
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "Hots On for Nowhere"));
        songList.add(new Songs(R.drawable.presence_album_led_zeppelin, "Tea for One"));
