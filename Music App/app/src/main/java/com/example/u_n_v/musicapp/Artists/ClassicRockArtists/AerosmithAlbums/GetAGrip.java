...
public class GetAGrip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Intro"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Eat the Rich"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Get a Grip"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Fever"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Livin' on the Edge"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Flesh"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Walk On Down"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Shut Up and Dance"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Cryin"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Gotta Love It"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Crazy"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Line Up (featuring Lenny Kravitz)"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Amazing"));
        songList.add(new Songs(R.drawable.meteora_album_linkin_park, "Boogie Man (instrumental)"));
