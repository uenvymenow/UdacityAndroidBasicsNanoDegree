...
public class HaveANiceDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Have a Nice Day"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "I Want to Be Loved"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Welcome to Wherever You Are"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Who Says You Can't Go Home"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Last Man Standing"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Bells of Freedom"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Wildflower"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Last Cigarette"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "I Am"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Complicated"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Novocaine"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Story of My Life"));
        songList.add(new Songs(R.drawable.have_a_nice_day_album_bon_jovi, "Who Says You Can't Go Home (duet version with Jennifer Nettles)"));
