...
public class LetItGo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Last Dollar (Fly Away)"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "I'm Workin"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Let It Go"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Whiskey and You"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Suspicions"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Kristofferson"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Put Your Lovin' on Me"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Nothin' to Die For"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Between the River and Me"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Train #10"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "I Need You"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Comin' Home"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "Shotgun Rider"));
        songList.add(new Songs(R.drawable.let_it_go_album_tim_mcgraw, "If You're Reading This"));
