...
public class BulletsInTheGun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Bullets in the Gun"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Somewhere Else"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Trailerhood"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "In a Couple of Days"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Think About You All of the Time"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Kissin' in the Rain"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Drive it on Home"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Ain't Breakin' Nothin'"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Is That All You Got"));
        songList.add(new Songs(R.drawable.bullets_in_the_gun_album_toby_keith, "Get Out of My Car"));
