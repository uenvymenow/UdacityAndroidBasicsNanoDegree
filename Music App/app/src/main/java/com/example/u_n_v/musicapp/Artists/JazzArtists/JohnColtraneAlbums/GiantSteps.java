...
public class GiantSteps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Giant Steps"));
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Cousin Mary"));
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Countdown"));
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Spiral"));
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Syeeda's Song Flute"));
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Naima"));
        songList.add(new Songs(R.drawable.giant_steps_album_john_coltrane, "Mr. P.C."));
